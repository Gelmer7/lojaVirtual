                ...
                <div class="card-body">
                    <form class="form-horizontal" action="cadastrarcliente.php" method="post">
                        ...
                        <div class="control-group <?php echo !empty($telefoneErro)?'error ': '';?>">
                            ...
                            <div class="controls">
                                <input type="number_format" size="35" class="form-control" name="telefone"
                                    placeholder="(31)98948844" required=""
                        ...
                        <div class="control-group <?php echo !empty($emailErro)?'error ': '';?>">
                            ...
                            <div class="controls">
                                <input type="email" size="40" class="form-control" name="email" placeholder="Email"
                                ...
                                <div class="form-check">
                                    ...
                                    <p class="form-check-label">
                                        <input class="form-check-input" type="radio" name="sexo" id="sexo" value="M"
                                            <?php echo isset($sexo) && $sexo == "M" ? "checked" : null; ?> /> Masculino
                                    </p>
                                ...
                                <div class="form-check">
                                    ...
                                    <p class="form-check-label">
                                        <input class="form-check-input" type="radio" name="sexo" id="sexo" value="F"
                                            <?php echo isset($sexo) && $sexo == "F" ? "checked" : null; ?> /> Feminino
                                    </p>
